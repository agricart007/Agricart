...
if(isset($_POST['save_password'])) {
    ...
    $check_password_query = "SELECT password FROM buyer_details WHERE email = '$username'";
    ...
    if(password_verify($current_password, $stored_hashed_password)) {
        ...
        if($new_password === $confirm_password) {
            ...
            $update_query = "UPDATE buyer_details SET password='$hashed_password' WHERE email = '$username'";
